            ...
            <div class="d-flex gap-5 justify-content-center">
            	<div class="list-group mx-0">
    				<label class="list-group-item d-flex gap-2">
      					<input class="form-check-input flex-shrink-0" type="radio" name="role" id="admin" value="admin" >
      					<span>Admin</span>
      					<input class="form-check-input flex-shrink-0" type="radio" name="role" id="user" value="user" checked>
      					<span>User</span>
    				</label>
  				</div>           
  			</div>
