		...
		try {
			...
			if (role.equalsIgnoreCase("admin")) {
				...
				if(admin.isValid()){
					...
					RequestDispatcher view = request.getRequestDispatcher("/Admin/Home/index.jsp"); // staff page
				...
				if(user.isValid()){
					...
					RequestDispatcher view = request.getRequestDispatcher("/User/Home/index.html"); // staff page
					view.forward(request, response);
				}
			}
		}
